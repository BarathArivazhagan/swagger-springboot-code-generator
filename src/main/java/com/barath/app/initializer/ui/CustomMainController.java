...
import com.barath.app.model.CustomProjectRequest;
...
@Controller
public class CustomMainController extends AbstractInitializrController{
	...
	public CustomMainController(InitializrMetadataProvider metadataProvider,
	...
	@ResponseBody
	public ResponseEntity<byte[]> springZip(CustomProjectRequest customRequest)
			throws IOException {
		ProjectRequest request = (ProjectRequest) customRequest;
		request.setVersion(request.getBootVersion());
		...
		modelGenerator.generateModel(requestModel,dir.toPath());
