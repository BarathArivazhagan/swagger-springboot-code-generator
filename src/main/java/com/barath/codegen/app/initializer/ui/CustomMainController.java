...
public class CustomMainController extends AbstractInitializrController{
	...
	private final CustomProjectGenerator projectGenerator;
	...
	public CustomMainController(InitializrMetadataProvider metadataProvider,
			...
			CustomProjectGenerator projectGenerator,
	...
	@RequestMapping(value="/starter.zip",method=RequestMethod.POST)
	@ResponseBody
